...
//     impact: "Strengthens emotional bonds"
//   },
//   {
//     icon: '🤝',
//     value: 8,
...
//     icon: '❤️',
//     value: 5,
//     description: "Love & Care",
//     impact: "Creates nurturing environment"
//   },
//   {
//     icon: '🎁',
//     value: 3,
//     description: "Sharing",
//     impact: "Develops generosity"
//   },
//   {
//     icon: '📚',
//     value: 7,
//     description: "Education",
//     impact: "Empowers future generations"
//   }
// ];
...
//     icon: '📱',
//     value: -5,
//     description: "Phone Addiction",
//     impact: "Reduces family time"
//   },
//   {
//     icon: '💢',
//     value: -8,
//     description: "Anger",
//     impact: "Damages relationships"
//   },
//   {
//     icon: '💔',
//     value: -10,
//     description: "Neglect",
//     impact: "Weakens family bonds"
//   },
//   {
//     icon: '⏰',
//     value: -3,
//     description: "Time Waste",
...
//     impact: "Creates family tension"
//   }
// ];

// export default function LevelTwo({ onComplete, onBack }: LevelTwoProps) {
...
//         const itemTemplate = itemArray[Math.floor(Math.random() * itemArray.length)];
...
//               return { ...item, y: GAME_HEIGHT + 100 }; // Move out of view
//             }
//           }
...
//       setBasketPosition(Math.max(BASKET_WIDTH/2, Math.min(x, GAME_WIDTH - BASKET_WIDTH/2)));
//     }
//   };
...
//                 exit={{ opacity: 0, y: -20 }}
//                 className={`absolute top-4 left-1/2 transform -translate-x-1/2 px-4 py-2 rounded-lg text-white text-sm
//                   ${lastCaughtItem.type === 'positive' ? 'bg-green-500' : 'bg-red-500'}`}
//               >
...
//                   {score >= targetScore ? '🎉 Level Complete!' : '😔 Level Failed'}
//                 </h2>
...
//                       <div className="text-xl font-bold text-teal-600">{positivesCaught}</div>
//                     </div>
//                     <div className="text-center p-2 bg-blue-50 rounded-lg">
//                       <div className="text-sm text-gray-600">Target Score</div>
//                       <div className="text-xl font-bold text-blue-600">{targetScore}</div>
//                     </div>
//                   </div>
//                   <div className="mt-4 p-4 bg-gradient-to-r from-teal-50 to-blue-50 rounded-lg">
//                     <p className="text-sm text-gray-800 italic">
//                       "Great nations can only be built on the foundation of family values. Man-making or character building should start at the family stage."
//                     </p>
//                   </div>
//                 </div>
...
//     icon: '🤝',
//     value: 8,
//     description: "Celebrating Milestones (Birthdays, Anniversaries)",
